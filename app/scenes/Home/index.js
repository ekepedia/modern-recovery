        ...
        return (<div className={classes.container} style={{background: STAGES[this.state.stageIndex].gradient, transition: "1s"}}>
            <div className={classes.Desktop}>
                ...
                <div style={{display: "flex", flexDirection: "column", height: "100vh", width: "100vw", overflow: "hidden"}}>
                    ...
                    {this.state.chapter ?
                        <div style={{flex: 1, height: "100%", width: "100%", overflow: "hidden", opacity: this.state.mounted ? 1 : 0, transition: "1s", outline: "none"}}>
                                                    ...
                                                    <div id="test-scroll-1" style={{paddingTop: "150px", paddingBottom: "150px", background: "black",}}>
                                                        ...
                                                        <form id="salesforce-form" target="dummyframe" onSubmit={(e) => this.handleSalesForceSubmit(e)}
                                                           ...
                                                           <div className={classes.signUpButton}
                                                                style={{
                                                                    position: "relative",
                                                                    background: this.state.sent ? (this.state.sentBot ? "black" : "white") : null,
                                                                    overflow: "hidden",
                                                                    color: this.state.sentBot ? "white" : null,
                                                                    transition: "0.5s"
                                                                }}
                                                           >
                                                               ...
                                                               <div style={{
                                                                   ...
                                                                   width: "100%",
                                                                   borderRadius: "100px",
                                                                   left: this.state.sent ? "0" : "-100%",
                                                                   opacity: this.state.sentBot ? 0 : (this.state.sent ? 1 : 0),
                                                                   top: 0,
                                                                   ...
                                                                   animationTimingFunction: "ease-in-out",
                                                                   color: this.state.changeSentText ? "white" : "rgba(0,0,0,0)"
                                                               }}>SENT!</div>
                                                           </div>
                        ...
                        :
                        <div id="canvas-holder" style={{flex: 1, background: this.state.darkBot ? "#272F46" : "#E4D7C4", height: "100%", overflow: "hidden", width: "100%", textAlign: "center", opacity: this.state.mounted ? 1 : 0, transition: "1s",  outline: "none"}}>
